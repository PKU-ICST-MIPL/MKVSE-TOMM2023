export PYTHONPATH=${PROJECT_PATH}/MGCN
DATASET_NAME='coco'
...
CUDA_VISIBLE_DEVICES=1,2,3 python train.py \
  ...
  --num_epochs 25 --lr_update 15 --learning_rate .0005 --precomp_enc_type basic --workers 5 \
  --log_step 1000 --embed_size 1024 --vse_mean_warmup_epochs 1 --batch_size 128 \
  --lr_MLGCN 0.0002  --cat_weight 0.95 --n_layers_concept_decoder 1
