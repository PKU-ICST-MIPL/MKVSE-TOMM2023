...
def main():
    ...
    opt.num_attribute = 300 # dimension of Attribute annotation
    opt.input_channel = 300 # dimension of initial concept embedding
    opt.adj_file = os.path.join(opt.data_path, opt.data_name, 'Concept_annotations',
                                opt.data_name+'_adj_concepts.pkl')# file for matirx of co-occurrence numbers
